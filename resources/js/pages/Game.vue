...
import carAtom from '@/assets/flag.png'
...
const carData: Record<number, CarDetails> = {
  1: { brand: "Флаг Республики Татарстан", description: "Символ гордости и единства татарского народа с зелёным, белым и красным цветами." },
  2: { brand: "Бабушка", description: "Мудрая хранительница семейных традиций и тёплых объятий." },
  3: { brand: "Татарская бабушка", description: "Сердце татарского дома, мастерица чак-чак и сказок на ночь." },
  4: { brand: "Чак Чак", description: "Сладкий татарский десерт из теста и меда — лакомство праздников." },
  5: { brand: "Эчпочмак", description: "Традиционный татарский пирожок с мясом и луком, запечённый до золотистой корочки." },
  6: { brand: "Татнефть", description: "Крупнейшая нефтяная компания Татарстана, энергетика и сила региона." },
  7: { brand: "АК Барс Банк", description: "Надёжный банк Татарстана с современными услугами для всех." },
  8: { brand: "Зилант", description: "Древнее существо, что хранит сокровища на дне Озера Кабан." },
  9: { brand: "Тюбетей", description: "Традиционная татарская шапочка, символ уюта и национального стиля." },
  10: { brand: "АК Барс", description: "Хоккейный клуб КХЛ из Казани — чемпионы и гордость болельщиков." },
  11: { brand: "Казанский кремль", description: "Объект ЮНЕСКО, древняя крепость с мечетями и башнями Казани." },
  12: { brand: "Чаша", description: "Казанский центр семьи «Казан» — действующий ЗАГС в форме гигантской чаши." },
  13: { brand: "Тюбетейка", description: "Яркая расшитая шапочка, излюбленный аксессуар татарских мужчин." },
  14: { brand: "Рустем Минниханов", description: "Глава Татарстана, лидер развития республики и её традиций." },
  15: { brand: "Алга", description: "Боевое клич татар — символ победы, спорта и национального духа." }
};
